   ...
   /* :-[ / :-@  */ rage: /:-?[\[@]/g,
         ...
         /* :-1: */ //thumbsdown: /:\-1:/g, // nlttoan removed because of wrong expression
            ...
            function insertEmojicon(args) {
                ...
                if(args.replacer){
                    ...
                    if (elementType !== 'img') {
                        ...
                        /* Begin - nlttoan added for Unseen emotion icons */
                        var file_path = (args.emojiName === args.emojiPath) ?
                            (defaultConfig.img_dir + '/' + args.emojiName + '.png') :
                            (defaultConfig.img_dir + '/' + args.emojiPath);
                        /* End */
            ...
            function getEmojiNameForMatch(match) {
                ...
                if(match[1] && match[2]) {
                    var named = match[2];
                    if(namedMatchHash[named]) { return /*named*/[named, file_name[named] ? file_name[named] : named ]/**/; }
                    return;
                }
