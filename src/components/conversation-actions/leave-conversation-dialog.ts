...
import LeaveConversationDialogTemplate from './leave-conversation-dialog.html!text';

@template(LeaveConversationDialogTemplate)
export default class LeaveConversationDialog extends Element {
    ...
    onOKButtonClick(e: UIEvent) {
        ...
        model.conversations.tools.leaveConversation(this.conv.id).then((resp) => {
