...
@template(templates.contacts.ContactPanelTemplate)
export class ContactPanel extends ComponentBase {
...
@template(templates.contacts.ContactListTemplate)
...
@template(templates.contacts.ContactSearchTemplate)
export class ContactSearch extends Element {
    keyup(event) {
