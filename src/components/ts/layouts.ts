...
@template(templates.layouts.FixedLayout)
export class FixedLayout extends Element {

}

@template(templates.layouts.SmSplitterTemplate)
...
@template(templates.layouts.SmPaneTemplate)
